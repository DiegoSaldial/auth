...
func (ec *executionContext) _Query_rolesByUsuario(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNRolesUserResponse2ᚕᚖinventariosᚋgraphᚋmodelᚐRolesUserResponseᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNRolesUserResponse2ᚕᚖinventariosᚋgraphᚋmodelᚐRolesUserResponseᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.RolesUserResponse) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNRolesUserResponse2ᚖinventariosᚋgraphᚋmodelᚐRolesUserResponse(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNRolesUserResponse2ᚖinventariosᚋgraphᚋmodelᚐRolesUserResponse(ctx context.Context, sel ast.SelectionSet, v *model.RolesUserResponse) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
