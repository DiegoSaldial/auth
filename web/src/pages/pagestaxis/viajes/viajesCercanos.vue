  ...
  <div class="q-pa-md">
    ...
    <q-table title="Viajes registrados" :loading="loading" :rows="viajes" :columns="columns"
      ...
      <template v-slot:top-right>
        <q-input outlined dense v-model.number="lat" step="0.01" type="number" label="latitud:" class="q-mr-xl">
          <template v-slot:append>
            <q-icon name="search" />
          </template>
        </q-input>

        <q-input outlined dense v-model.number="lon" step="0.01" type="number" label="longitud:" class="q-mr-xl">
          <template v-slot:append>
            <q-icon name="search" />
          </template>
        </q-input>

        <q-input outlined dense v-model.number="radio" type="number" label="Radio:" class="q-mr-xl">
          <template v-slot:append>
            <q-icon name="search" />
          </template>
        </q-input>
